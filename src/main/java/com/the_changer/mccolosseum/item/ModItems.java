...
public class ModItems {
    ...
    public static final Item Absorption_Item = registerItem("absorption_item",
            new AbsorptionItem(new FabricItemSettings().group(ItemGroup.COMBAT).maxCount(1)));
    public static final Item Fire_Resistance_Item = registerItem("fire_resistance_item",
            new FireResistanceItem(new FabricItemSettings().group(ItemGroup.COMBAT).maxCount(1)));
    public static final Item Jump_Boost_Item = registerItem("jump_boost_item",
            new JumpBoostItem(new FabricItemSettings().group(ItemGroup.COMBAT).maxCount(1)));
    public static final Item Regeneration_Item = registerItem("regeneration_item",
            new RegenerationItem(new FabricItemSettings().group(ItemGroup.COMBAT).maxCount(1)));
    public static final Item Resistance_Item = registerItem("resistance_item",
            new ResistanceItem(new FabricItemSettings().group(ItemGroup.COMBAT).maxCount(1)));
