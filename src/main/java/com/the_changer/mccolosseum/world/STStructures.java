package com.the_changer.mccolosseum.world;

import com.the_changer.mccolosseum.mccolosseum;
import com.the_changer.mccolosseum.world.structures.SkyStructures;
...
public class STStructures {
    ...
    public static void registerStructureFeatures() {
        SKY_STRUCTURES = Registry.register(Registry.STRUCTURE_TYPE, new Identifier(mccolosseum.MOD_ID, "sky_structures"), () -> SkyStructures.CODEC);
    }
}